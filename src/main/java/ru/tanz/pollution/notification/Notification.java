package ru.tanz.pollution.notification;
...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/sucess.png")));
            lbMessage.setText("Успешно!");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/info.png")));
            lbMessage.setText("Информация");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/warning.png")));
            lbMessage.setText("Ошибка!");
        }
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/sucess.png"))); // NOI18N
